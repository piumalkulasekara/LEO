...
function _logType(t, e) {
	var i, n, s;
	i = Array.prototype.slice.call(e), n = function () {}, s = window.console || {
		log: n,
		warn: n,
		error: n
	}, t ? i.unshift(t.toUpperCase() + ":") : t = "log", vjs.log.history.push(i), i.unshift("VIDEOJS:"), s[t].apply ? s[t].apply(s, i) : s[t](i.join(" "))
}
var Util = function ($) {
		function t(t) {
		...
		function i() {
			return {
				...
				delegateType: r.end,
				handle: function t(e) {
					return $(e.target).i.s(this) ? e.handleObj.handler.apply(this, arguments) : void 0
				}
			}
		}
	...
	Carousel = function ($) {
		var t = "carousel",
			...
			d = function () {
				function s(t, e) {
					_classCallCheck(this, s), this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this._config = this._getConfig(e), this._element = $(t)[0], this._indicatorsElement = $(this._element).find(p.INDICATORS)[0], this._addEventListeners()
				}
				return _createClass(s, [{
					...
					key: "pause",
					value: function f(t) {
						t || (this._isPaused = !0), $(this._element).find(p.NEXT_PREV)[0] && Util.supportsTransitionEnd() && (Util.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
					}
				}, {
					key: "cycle",
					value: function g(t) {
						t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval($.proxy(document.visibilityState ? this.nextWhenVisible : this.next, this), this._config.interval))
					}
				}, {
					key: "to",
					value: function y(t) {
						...
						if (!(t > this._items.length - 1 || 0 > t)) {
							if (this._isSliding) return void $(this._element).one(c.SLID, function () {
								return e.to(t)
							});
					...
					key: "dispose",
					value: function m() {
						$(this._element).off(n), $.removeData(this._element, i), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
					}
				}, {
					key: "_getConfig",
					value: function j(e) {
					...
					value: function b() {
						this._config.keyboard && $(this._element).on(c.KEYDOWN, $.proxy(this._keydown, this)), "hover" !== this._config.pause || "ontouchstart" in document.documentElement || $(this._element).on(c.MOUSEENTER, $.proxy(this.pause, this)).on(c.MOUSELEAVE, $.proxy(this.cycle, this))
					}
				}, {
					key: "_keydown",
					value: function C(t) {
					...
					value: function k(t, e) {
						...
						if (!l.isDefaultPrevented() && n && s) {
							...
							Util.supportsTransitionEnd() && $(this._element).hasClass(u.SLIDE) ? ($(s).addClass(t), Util.reflow(s), $(n).addClass(a), $(s).addClass(a), $(n).one(Util.TRANSITION_END, function () {
								$(s).removeClass(a).removeClass(t), $(s).addClass(u.ACTIVE), $(n).removeClass(u.ACTIVE).removeClass(t).removeClass(a), i._isSliding = !1, setTimeout(function () {
									return $(i._element).trigger(d)
								}, 0)
							}).emulateTransitionEnd(r)) : ($(n).removeClass(u.ACTIVE), $(s).addClass(u.ACTIVE), this._isSliding = !1, $(this._element).trigger(d)), o && this.cycle()
						}
					}
				}], [{
		...
		return $(document).on(c.CLICK_DATA_API, p.DATA_SLIDE, d._dataApiClickHandler), $(window).on(c.LOAD_DATA_API, function () {
			$(p.DATA_RIDE).each(function () {
				var t = $(this);
				d._jQueryInterface.call(t, t.data())
			})
		}), $.fn[t] = d._jQueryInterface, $.fn[t].Constructor = d, $.fn[t].noConflict = function () {
	...
	Collapse = function ($) {
		var t = "collapse",
			...
			d = function () {
				function n(t, e) {
					_classCallCheck(this, n), this._isTransitioning = !1, this._element = t, this._config = this._getConfig(e), this._triggerArray = $.makeArray($('[data-toggle="collapse"][href="#' + t.id + '"],' + ('[data-toggle="collapse"][data-target="#' + t.id + '"]'))), this._parent = this._config.parent ? this._getParent() : null, this._config.parent || this._addAriaAndCollapsedClass(this._element, this._triggerArray), this._config.toggle && this.toggle()
				}
				return _createClass(n, [{
						...
						if (!this._isTransitioning && !$(this._element).hasClass(c.IN)) {
							...
							if (this._parent && (e = $.makeArray($(p.ACTIVES)), e.length || (e = null)), !(e && (s = $(e).data(i), s && s._isTransitioning))) {
								...
								if ($(this._element).trigger(o), !o.isDefaultPrevented()) {
									...
									$(this._element).removeClass(c.COLLAPSE).addClass(c.COLLAPSING), this._element.style[a] = 0, this._element.setAttribute("aria-expanded", !0), this._triggerArray.length && $(this._triggerArray).removeClass(c.COLLAPSED).attr("aria-expanded", !0), this.setTransitioning(!0);
									var l = function v() {
					...
					value: function d() {
						...
						if (!this._isTransitioning && $(this._element).hasClass(c.IN)) {
							...
							if ($(this._element).trigger(e), !e.isDefaultPrevented()) {
								...
								this._element.style[i] = this._element[n] + "px", Util.reflow(this._element), $(this._element).addClass(c.COLLAPSING).removeClass(c.COLLAPSE).removeClass(c.IN), this._element.setAttribute("aria-expanded", !1), this._triggerArray.length && $(this._triggerArray).addClass(c.COLLAPSED).attr("aria-expanded", !1), this.setTransitioning(!0);
								var s = function o() {
					...
					value: function m() {
						...
						return $(e).find(i).each(function (e, i) {
		...
		return $(document).on(h.CLICK_DATA_API, p.DATA_TOGGLE, function (t) {
			t.preventDefault();
	...
	Modal = function ($) {
		var t = "modal",
			...
			d = function () {
				function s(t, e) {
					_classCallCheck(this, s), this._config = this._getConfig(e), this._element = t, this._dialog = $(t).find(p.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0
				}
				return _createClass(s, [{
					key: "toggle",
					value: function o(t) {
					...
					value: function d(t) {
						...
						$(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), $(document.body).addClass(u.OPEN), this._setEscapeEvent(), this._setResizeEvent(), $(this._element).on(c.CLICK_DISMISS, p.DATA_DISMISS, $.proxy(this.hide, this)), $(this._dialog).on(c.MOUSEDOWN_DISMISS, function () {
					...
					value: function v(t) {
						t && t.preventDefault();
						var e = $.Event(c.HIDE);
						$(this._element).trigger(e), this._isShown && !e.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), $(document).off(c.FOCUSIN), $(this._element).removeClass(u.IN), $(this._element).off(c.CLICK_DISMISS), $(this._dialog).off(c.MOUSEDOWN_DISMISS), Util.supportsTransitionEnd() && $(this._element).hasClass(u.FADE) ? $(this._element).one(Util.TRANSITION_END, $.proxy(this._hideModal, this)).emulateTransitionEnd(r) : this._hideModal())
					}
				}, {
					key: "dispose",
					value: function f() {
						$.removeData(this._element, i), $(window).off(n), $(document).off(n), $(this._element).off(n), $(this._backdrop).off(n), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._originalBodyPadding = null, this._scrollbarWidth = null
					}
				}, {
					key: "_getConfig",
					value: function g(e) {
					...
					value: function y(t) {
						...
						this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.scrollTop = 0, i && Util.reflow(this._element), $(this._element).addClass(u.IN), this._config.focus && this._enforceFocus();
						var n = $.Event(c.SHOWN, {
								relatedTarget: t
							}),
							s = function o() {
					...
					value: function m() {
						var t = this;
						$(document).off(c.FOCUSIN).on(c.FOCUSIN, function (e) {
					...
					value: function j() {
						var t = this;
						this._isShown && this._config.keyboard ? $(this._element).on(c.KEYDOWN_DISMISS, function (e) {
							27 === e.which && t.hide()
					...
					value: function T(t) {
						...
						if (this._isShown && this._config.backdrop) {
							...
							if (this._backdrop = document.createElement("div"), this._backdrop.className = u.BACKDROP, i && $(this._backdrop).addClass(i), $(this._backdrop).appendTo(document.body), $(this._element).on(c.CLICK_DISMISS, function (t) {
								...
								}), n && Util.reflow(this._backdrop), $(this._backdrop).addClass(u.IN), !t) return;
							if (!n) return void t();
		...
		return $(document).on(c.CLICK_DATA_API, p.DATA_TOGGLE, function (t) {
			var e = this,
				n = void 0,
			...
			var r = $(n).one(c.SHOW, function (t) {
				t.isDefaultPrevented() || r.one(c.HIDDEN, function () {
...
function (t) {
	...
	function t(t) {
		var e = {},
			i = /^jQuery\d+$/;
		return $.each(t.attributes, function (t, n) {
	...
	var s = "[object OperaMini]" === Object.prototype.toString.call(window.operamini),
		...
		l = $.propHooks,
		h, c, u = {};
	o && r ? (c = $.fn.placeholder = function () {
		return this
	}, c.input = !0, c.textarea = !0) : (c = $.fn.placeholder = function (t) {
		var n = {
			customClass: "placeholder"
		};
		return u = $.extend({}, n, t), this.filter((o ? "textarea" : ":input") + "[placeholder]").not("." + u.customClass).bind({
			"focus.placeholder": e,
			"blur.placeholder": i
		}).data("placeholder-enabled", !0).trigger("blur.placeholder")
	}, c.input = o, c.textarea = r, h = {
		get: function (t) {
			var e = $(t),
		...
		set: function (t, s) {
			var o = $(t),
				r, a;
			return "" !== s && (r = o.data("placeholder-textinput"), a = o.data("placeholder-password"), r ? (e.call(r[0], !0, s) || (t.value = s), r[0].value = s) : a && (e.call(t, !0, s) || (a[0].value = s), t.value = s)), o.data("placeholder-enabled") ? ("" === s ? (t.value = s, t != n() && i.call(t)) : (o.hasClass(u.customClass) && e.call(t), t.value = s), o) : (t.value = s, o)
		}
	}, o || (a.input = h, l.value = h), r || (a.textarea = h, l.value = h), $(function () {
...
vjs.CDN_VERSION = "4.12", vjs.ACCESS_PROTOCOL = "https:" == document.location.protocol ? "https://" : "http://", vjs.VERSION = "4.12.11", vjs.options = {
	...
	var e, i;
	t = t || {}, e = t.init || t.init || this.prototype.init || this.prototype.init || function () {}, i = function () {
		e.apply(this, arguments)
	}, i.prototype = vjs.obj.create(this.prototype), i.prototype.constructor = i, i.extend = vjs.CoreObject.extend, i.create = vjs.CoreObject.create;
	...
	var n = vjs.getData(t);
	n.handlers || (n.handlers = {}), n.handlers[e] || (n.handlers[e] = []), i.guid || (i.guid = vjs.guid++), n.handlers[e].push(i), n.dispatcher || (n.disabled = !1, n.dispatcher = function (e) {
		if (!n.disabled) {
			e = vjs.fixEvent(e);
			var i = n.handlers[e.type];
			if (i)
				for (var s = i.slice(0), o = 0, r = s.length; r > o && !e.isImmediatePropagationStopped(); o++) s[o].call(t, e)
		}
		...
		if (n.handlers) {
			...
			if (e) {
				...
				if (o) {
					...
					if (i.guid)
						for (var r = 0; r < o.length; r++) o[r].guid === i.guid && o.splice(r--, 1);
	...
	var i = vjs.getData(t);
	0 === i.handlers[e].length && (delete i.handlers[e], t.removeEventListener ? t.removeEventListener(e, i.dispatcher, !1) : t.detachEvent && t.detachEvent("on" + e, i.dispatcher)), vjs.isEmpty(i.handlers) && (delete i.handlers, delete i.dispatcher, delete i.disabled), vjs.isEmpty(i) && vjs.removeData(t)
	...
	if (!t || !t.isPropagationStopped) {
		...
		if (t.target || (t.target = t.srcElement || document), t.relatedTarget = t.fromElement === t.target ? t.toElement : t.fromElement, t.preventDefault = function () {
			...
			}, t.isDefaultPrevented = i, t.defaultPrevented = !1, t.stopPropagation = function () {
	...
	if ("string" == typeof e && (e = {
			type: e,
			target: t
		}), e = vjs.fixEvent(e), i.dispatcher && i.dispatcher.call(t, e), n && !e.isPropagationStopped() && e.bubbles !== !1) vjs.trigger(n, e);
...
vjs.createEl = function (t, e) {
		var i;
		return t = t || "div", e = e || {}, i = document.createElement(t), vjs.obj.each(e, function (t, e) {
	...
	function () {
		...
		var e, i, n, s, o;
		s = ["protocol", "hostname", "port", "pathname", "search", "hash", "host"], i = vjs.createEl("a", {
			href: t
		}), n = "" === i.host && "file:" !== i.protocol, n && (e = vjs.createEl("div"), e.innerHTML = '<a href="' + t + '"></a>', i = e.firstChild, e.setAttribute("style", "display:none; position:absolute;"), document.body.appendChild(e)), o = {};
		...
		return t.getBoundingClientRect && t.parentNode && (e = t.getBoundingClientRect()), e ? (i = document.documentElement, n = document.body, s = i.clientLeft || n.clientLeft || 0, o = window.pageXOffset || n.scrollLeft, r = e.left + o - s, a = i.clientTop || n.clientTop || 0, l = window.pageYOffset || n.scrollTop, h = e.top + l - a, {
			left: vjs.round(r),
			top: vjs.round(h)
		}) : {
			left: 0,
	...
	}, vjs.arr = {}, vjs.arr.forEach = function (t, e, i) {
		if (vjs.obj.isArray(t) && e instanceof Function)
			for (var n = 0, s = t.length; s > n; ++n) e.call(i || vjs, t[n], n, t);
		return t
		...
		}), n = new i, n.uri = t.uri, s = vjs.parseUrl(t.uri), o = window.location, a = s.protocol + s.host !== o.protocol + o.host, !a || !window.XDomainRequest || "withCredentials" in n ? (r = "file:" == s.protocol || "file:" == o.protocol, n.onreadystatechange = function () {
			if (4 === n.readyState) {
		...
		init: function (t, e, i) {
			this.player_ = t, this.options_ = vjs.obj.copy(this.options_), e = this.options(e), this.id_ = e.id || e.el && e.el.id, this.id_ || (this.id_ = (t.id && t.id() || "no_player") + "_component_" + vjs.guid++), this.name_ = e.name || null, this.el_ = e.el || this.createEl(), this.children_ = [], this.childIndex_ = {}, this.childNameIndex_ = {}, this.initChildren(), this.ready(i), e.reportTouchActivity !== !1 && this.enableTouchActivity()
		}
		...
		var i, n, s;
		return "string" == typeof t ? (s = t, e = e || {}, n = e.componentClass || vjs.capitalize(s), e.name = s, i = new window.videojs[n](this.player_ || this, e)) : i = t, this.children_.push(i), "function" == typeof i.id && (this.childIndex_[i.id()] = i), s = s || i.name && i.name(), s && (this.childNameIndex_[s] = i), "function" == typeof i.el && i.el() && this.contentEl().appendChild(i.el()), i
		...
		var n, s, o, r, a, l;
		return "string" == typeof t || vjs.obj.isArray(t) ? vjs.on(this.el_, t, vjs.bind(this, e)) : (n = t, s = e, o = vjs.bind(this, i), l = this, r = function () {
			l.off(n, s, o)
		}, r.guid = o.guid, this.on("dispose", r), a = function () {
			l.off("dispose", r)
		}, a.guid = o.guid, t.nodeName ? (vjs.on(n, s, o), vjs.on(n, "dispose", a)) : "function" == typeof t.on && (n.on(s, o), n.on("dispose", a))), this
	}, vjs.Component.prototype.off = function (t, e, i) {
		var n, s, o, r, a;
		return !t || "string" == typeof t || vjs.obj.isArray(t) ? vjs.off(this.el_, t, e) : (n = t, o = e, r = vjs.bind(this, i), this.off("dispose", r), t.nodeName ? (vjs.off(n, o, r), vjs.off(n, "dispose", r)) : (n.off(o, r), n.off("dispose", r))), this
	}, vjs.Component.prototype.one = function (t, e, i) {
		var n, s, o, r, a;
		return "string" == typeof t || vjs.obj.isArray(t) ? vjs.one(this.el_, t, vjs.bind(this, e)) : (n = t, s = e, o = vjs.bind(this, i), r = this, a = function () {
			r.off(n, s, a), o.apply(this, arguments)
		}, a.guid = o.guid, this.on(n, s, a)), this
		...
		if (void 0 !== e) return (null === e || vjs.isNaN(e)) && (e = 0), -1 !== ("" + e).indexOf("%") || -1 !== ("" + e).indexOf("px") ? this.el_.style[t] = e : "auto" === e ? this.el_.style[t] = "" : this.el_.style[t] = e + "px", i || this.trigger("resize"), this;
		...
		t = 0, e = null, l = 10, h = 200, this.on("touchstart", function (i) {
		...
		return e = vjs.obj.merge({
			...
			"aria-live": "polite",
			tabIndex: 0
		}, e), i = vjs.Component.prototype.createEl.call(this, t, e), e.innerHTML || (this.contentEl_ = vjs.createEl("div", {
			className: "vjs-control-content"
		}), this.controlText_ = vjs.createEl("span", {
			className: "vjs-control-text",
			innerHTML: this.localize(this.buttonText) || "Need Text"
		}), this.contentEl_.appendChild(this.controlText_), i.appendChild(this.contentEl_)), i
...
if (function () {
		...
		for (vjs.browser.fullscreenAPI, t = [
			...
			], e = t[0], n = 0; n < t.length; n++)
			if (t[n][1] in document) {
				i = t[n];
				break
			}
		if (i)
			for (vjs.browser.fullscreenAPI = {}, n = 0; n < i.length; n++) vjs.browser.fullscreenAPI[e[n]] = i[n]
	}(), vjs.Player = vjs.Component.extend({
		init: function (t, e, i) {
			this.tag = t, t.id = t.id || "vjs_video_" + vjs.guid++, this.tagAttributes = t && vjs.getElementAttributes(t), e = vjs.obj.merge(this.getTagSettings(t), e), this.language_ = e.language || vjs.options.language, this.languages_ = e.languages || vjs.options.languages, this.cache_ = {}, this.poster_ = e.poster || "", this.controls_ = !!e.controls, t.controls = !1, e.reportTouchActivity = !1, this.isAudio("audio" === this.tag.nodeName.toLowerCase()), vjs.Component.call(this, this, e, i), this.controls() ? this.addClass("vjs-controls-enabled") : this.addClass("vjs-controls-disabled"), this.isAudio() && this.addClass("vjs-audio"), vjs.players[this.id_] = this, e.plugins && vjs.obj.each(e.plugins, function (t, e) {
				this[t](e)
		...
		var t = this.el_ = vjs.Component.prototype.createEl.call(this, "div"),
			e = this.tag,
			i;
		return e.removeAttribute("width"), e.removeAttribute("height"), i = vjs.getElementAttributes(e), vjs.obj.each(i, function (e) {
			"class" == e ? t.className = i[e] : t.setAttribute(e, i[e])
		}), e.id += "_html5_api", e.className = "vjs-tech", e.player = t.player = this, this.addClass("vjs-paused"), this.width(this.options_.width, !0), this.height(this.options_.height, !0), e.initNetworkState_ = e.networkState, e.parentNode && e.parentNode.insertBefore(t, e), vjs.insertFirst(e, t), this.el_ = t, this.on("loadstart", this.onLoadStart), this.on("waiting", this.onWaiting), this.on(["canplay", "canplaythrough", "playing", "ended"], this.onWaitEnd), this.on("seeking", this.onSeeking), this.on("seeked", this.onSeeked), this.on("ended", this.onEnded), this.on("play", this.onPlay), this.on("firstplay", this.onFirstPlay), this.on("pause", this.onPause), this.on("progress", this.onProgress), this.on("durationchange", this.onDurationChange), this.on("fullscreenchange", this.onFullscreenChange), t
		...
		}, this.on("mousedown", i), this.on("mousemove", e), this.on("mouseup", s), this.on("keydown", t), this.on("keyup", t), o = this.setInterval(function () {
		...
		var t, e, i, n, s = this.player_.buffered(),
		...
		if (e)
			for (var i = e.length - 1; i >= 0; i--) t.addChild(new vjs.PlaybackRateMenuItem(this.player(), {
				rate: e[i] + "x"
			}));
		return t
		...
		vjs.MediaTechController = vjs.Component.extend({
			init: function (t, e, i) {
				e = e || {}, e.reportTouchActivity = !1, vjs.Component.call(this, t, e, i), this.featuresProgressEvents || this.manualProgressOn(), this.featuresTimeupdateEvents || this.manualTimeUpdatesOn(), this.initControlsListeners(), this.featuresNativeTextTracks || this.emulateTextTracks(), this.initTextTrackListeners()
			}
			...
			e = this.textTracks(), e && (e.addEventListener("removetrack", i), e.addEventListener("addtrack", i), this.on("dispose", vjs.bind(this, function () {
				e.removeEventListener("removetrack", i), e.removeEventListener("addtrack", i)
			})))
		}, vjs.MediaTechController.prototype.emulateTextTracks = function () {
			var t = this.player_,
				e, i, n;
			window.WebVTT || (n = document.createElement("script"), n.src = t.options()["vtt.js"] || "../node_modules/vtt.js/dist/vtt.js", t.el().appendChild(n), window.WebVTT = !0), i = this.textTracks(), i && (e = function () {
				var e, i, n;
				for (n = t.getChild("textTrackDisplay"), n.updateDisplay(), e = 0; e < this.length; e++) i = this[e], i.removeEventListener("cuechange", vjs.bind(n, n.updateDisplay)), "showing" === i.mode && i.addEventListener("cuechange", vjs.bind(n, n.updateDisplay))
			}, i.addEventListener("change", e), this.on("dispose", vjs.bind(this, function () {
			...
			return this.remoteTextTracks().addTrack_(i), {
				track: i
			}
			...
			t.registerSourceHandler = function (e, i) {
				...
				for (var i = t.sourceHandlers || [], n, s = 0; s < i.length; s++)
				...
				var i = t.selectSourceHandler(e);
				return i || (t.nativeSourceHandler ? i = t.nativeSourceHandler : vjs.log.error("No source hander found for the current source.")), this.disposeSourceHandler(), this.off("dispose", this.disposeSourceHandler), this.currentSource_ = e, this.sourceHandler_ = i.handleSource(e, this), this.on("dispose", this.disposeSourceHandler), this
		...
		if (!s || this.movingMediaElementInDOM === !1) {
			if (s ? (a = s.cloneNode(!1), vjs.Html5.disposeMediaElement(s), s = a, t.tag = null) : (s = vjs.createEl("video"), o = videojs.util.mergeOptions({}, t.tagAttributes), vjs.TOUCH_ENABLED && t.options().nativeControlsForTouch === !0 || delete o.controls, vjs.setElementAttributes(s, vjs.obj.merge(o, {
					id: t.id() + "_html5_api",
					"class": "vjs-tech"
				}))), s.player = t, t.options_.tracks)
				for (n = 0; n < t.options_.tracks.length; n++) e = t.options_.tracks[n], i = document.createElement("track"), i.kind = e.kind, i.label = e.label, i.srclang = e.srclang, i.src = e.src, "default" in e && i.setAttribute("default", "default"), s.appendChild(i);
		...
		for (var t = this.el_.querySelectorAll("track"), e, i = t.length, n = {
				captions: 1,
				subtitles: 1
			}; i--;) e = t[i].track, e && e.kind in n && !t[i]["default"] && (e.mode = "disabled")
		...
		var t, e, i, n, s;
		t = this, e = this.player(), t.setControls(e.controls()), i = function () {
			t.setControls(!0)
		}, n = function () {
			t.setControls(!1)
		}, e.on("controlsenabled", i), e.on("controlsdisabled", n), s = function () {
			e.off("controlsenabled", i), e.off("controlsdisabled", n)
		}, t.on("dispose", s), e.on("usingcustomcontrols", s), e.usingNativeControls(!0)
		...
		return t = t || {}, t.kind && (e.kind = t.kind), t.label && (e.label = t.label), (t.language || t.srclang) && (e.srclang = t.language || t.srclang), t["default"] && (e["default"] = t["default"]), t.id && (e.id = t.id), t.src && (e.src = t.src), this.el().appendChild(e), "metadata" === e.track.kind ? e.track.mode = "hidden" : e.track.mode = "disabled", e.onload = function () {
			var t = e.track;
		...
		vjs.Html5.patchCanPlayType = function () {
			vjs.ANDROID_VERSION >= 4 && (t || (t = vjs.TEST_VID.constructor.prototype.canPlayType), vjs.TEST_VID.constructor.prototype.canPlayType = function (i) {
		...
		init: function (t, e, i) {
			...
			}), t.on("stageclick", t.reportUserActivity), this.el_ = vjs.Flash.embed(e.swf, this.el_, r, a, l)
		}
		...
		vjs.TextTrack = function (e) {
			...
			return n.player_ = e.player, o = vjs.TextTrackMode[e.mode] || "disabled", r = vjs.TextTrackKind[e.kind] || "subtitles", a = e.label || "", l = e.language || e.srclang || "", s = e.id || "vjs_text_track_" + vjs.guid++, ("metadata" === r || "chapters" === r) && (o = "hidden"), n.cues_ = [], n.activeCues_ = [], h = new vjs.TextTrackCueList(n.cues_), c = new vjs.TextTrackCueList(n.activeCues_), p = !1, u = vjs.bind(n, function () {
				this.activeCues, p && (this.trigger("cuechange"), p = !1)
			}), "disabled" !== o && n.player_.on("timeupdate", u), Object.defineProperty(n, "kind", {
				get: function () {
					return r
				},
				...
				get: function () {
					...
					for (s = this.player_.currentTime(), t = 0, e = this.cues.length, n = []; e > t; t++) o = this.cues[t], o.startTime <= s && o.endTime >= s ? n.push(o) : o.startTime === o.endTime && o.startTime <= s && o.startTime + .5 >= s && n.push(o);
					if (p = !1, n.length !== this.activeCues_.length) p = !0;
					else
						for (t = 0; t < n.length; t++) - 1 === i.call(this.activeCues_, n[t]) && (p = !0);
					return this.activeCues_ = n, c.setCues_(this.activeCues_), c
				},
				set: Function.prototype
			}), e.src ? t(e.src, n) : n.loaded_ = !0, vjs.IS_IE8 ? n : void 0
			...
			var e = this.player_.textTracks(),
				i = 0;
			if (e)
				for (; i < e.length; i++) e[i] !== this && e[i].removeCue(t);
		...
		var t, e, i;
		t = function (t, i) {
			vjs.xhr(t, vjs.bind(this, function (t, n, s) {
		...
		for (t = t || [], e.tracks_ = [], Object.defineProperty(e, "length", {
				get: function () {
					return this.tracks_.length
				}
			}); n < t.length; n++) e.addTrack_(t[n]);
		...
		return vjs.TextTrackCueList.prototype.setCues_.call(e, t), Object.defineProperty(e, "length", {
			get: function () {
				return this.length_
			}
		}), vjs.IS_IE8 ? e : void 0
		...
		var e = this.length || 0,
			...
			n = t.length,
			s;
		if (this.cues_ = t, this.length_ = t.length, s = function (t) {
		...
		vjs.TextTrackDisplay = vjs.Component.extend({
			init: function (t, e, i) {
				vjs.Component.call(this, t, e, i), t.on("loadstart", vjs.bind(this, this.toggleDisplay)), t.ready(vjs.bind(this, function () {
		...
		vjs.TextTrackDisplay.prototype.updateDisplay = function () {
			...
			if (this.clearDisplay(), t)
				for (; e < t.length; e++) i = t[e], "showing" === i.mode && this.updateForTrack(i)
			...
			init: function (t, e) {
				...
				n && (s = vjs.bind(this, function () {
					...
					this.selected(t)
				}), n.addEventListener("change", s), t.on("dispose", function () {
					n.removeEventListener("change", s)
				})), e.label = i.label || i.language || "Unknown", e.selected = i["default"] || "showing" === i.mode, vjs.MenuItem.call(this, t, e), n && void 0 === n.onchange && this.on(["tap", "click"], function () {
			...
			var t = this.track.kind,
				...
				i, n, s = 0;
			if (vjs.MenuItem.prototype.onClick.call(this), e)
				for (; s < e.length; s++) n = e[s], n.kind === t && (n === this.track ? n.mode = "showing" : n.mode = "disabled")
			...
			init: function (t, e) {
				var i, n;
				vjs.MenuButton.call(this, t, e), i = this.player_.textTracks(), this.items.length <= 1 && this.hide(), i && (n = vjs.bind(this, this.update), i.addEventListener("removetrack", n), i.addEventListener("addtrack", n), this.player_.on("dispose", function () {
			...
			var t = [],
				e, i;
			if (!(this instanceof vjs.CaptionsButton) || this.player().tech && this.player().tech.featuresNativeTextTracks || t.push(new vjs.CaptionSettingsMenuItem(this.player_, {
					kind: this.kind_
				})), t.push(new vjs.OffTextTrackMenuItem(this.player_, {
					kind: this.kind_
				})), i = this.player_.textTracks(), !i) return t;
			for (var n = 0; n < i.length; n++) e = i[n], e.kind === this.kind_ && t.push(new vjs.TextTrackMenuItem(this.player_, {
				track: e
			}));
			return t
			...
			for (var t = this.player_.textTracks() || [], e = 0, i = t.length, n, s, o = this.items = []; i > e; e++)
				if (n = t[e], n.kind == this.kind_) {
					...
					n.mode = "hidden", window.setTimeout(vjs.bind(this, function () {
						this.createMenu()
					}), 100)
				}
			var r = this.menu;
			if (void 0 === r && (r = new vjs.Menu(this.player_), r.contentEl().appendChild(vjs.createEl("li", {
				...
				var a = s.cues,
					l, h;
				for (e = 0, i = a.length; i > e; e++) l = a[e], h = new vjs.ChaptersTrackMenuItem(this.player_, {
					track: s,
					cue: l
				}), o.push(h), r.addChild(h);
				this.addChild(r)
			}
		...
		vjs.TextTrackSettings = vjs.Component.extend({
			...
			e = this.el(), o = t(e.querySelector(".vjs-edge-style select")), r = t(e.querySelector(".vjs-font-family select")), a = t(e.querySelector(".vjs-fg-color > select")), n = t(e.querySelector(".vjs-text-opacity > select")), l = t(e.querySelector(".vjs-bg-color > select")), i = t(e.querySelector(".vjs-bg-opacity > select")), h = t(e.querySelector(".window-color > select")), s = t(e.querySelector(".vjs-window-opacity > select")), p = window.parseFloat(t(e.querySelector(".vjs-font-percent > select"))), c = {
				backgroundOpacity: i,
				textOpacity: n,
				windowOpacity: s,
				edgeStyle: o,
...
vjs.autoSetup = function () {
		var t, e, i, n, s, o = document.getElementsByTagName("video"),
			r = document.getElementsByTagName("audio"),
			a = [];
		if (o && o.length > 0)
			for (n = 0, s = o.length; s > n; n++) a.push(o[n]);
		if (r && r.length > 0)
			for (n = 0, s = r.length; s > n; n++) a.push(r[n]);
		if (a && a.length > 0)
	...
	function (t, e) {
		...
		function o(t, e, o) {
			...
			var c = "",
				...
				w = 50,
				T = "middle";
			return Object.defineProperty(a, "id", s({}, h, {
				get: function () {
					return c
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "pauseOnExit", s({}, h, {
				get: function () {
					return u
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "startTime", s({}, h, {
				get: function () {
					return p
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "endTime", s({}, h, {
				get: function () {
					return d
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "text", s({}, h, {
				get: function () {
					return v
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "region", s({}, h, {
				get: function () {
					return f
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "vertical", s({}, h, {
				get: function () {
					return g
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "snapToLines", s({}, h, {
				get: function () {
					return y
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "line", s({}, h, {
				get: function () {
					return m
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "lineAlign", s({}, h, {
				get: function () {
					return j
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "position", s({}, h, {
				get: function () {
					return b
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "positionAlign", s({}, h, {
				get: function () {
					return C
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "size", s({}, h, {
				get: function () {
					return w
				},
				set: function (t) {
			...
			})), Object.defineProperty(a, "align", s({}, h, {
				get: function () {
					return T
				},
				set: function (t) {
	...
	function (t) {
		...
		e.prototype = v(Error.prototype), e.prototype.constructor = e, e.Errors = {
			BadSignature: {
				code: 0,
		...
		h.prototype.applyStyles = function (t, e) {
			...
			return 0 === t ? 0 : t + e
		}, c.prototype = v(h.prototype), c.prototype.constructor = c, u.prototype.move = function (t, e) {
		...
		d.processCues = function (t, e, i) {
			...
			if (s.style.position = "absolute", s.style.left = "0", s.style.right = "0", s.style.top = "0", s.style.bottom = "0", s.style.margin = w, i.appendChild(s), n(e)) {
				...
				for (var h = 0; h < e.length; h++) s.appendChild(e[h].displayState)
	...
	function ($, t) {
		var e = {
			...
			init: function (t) {
				var e, i, n;
				t.originalEvent.origin.match(/vimeo/g) && "data" in t.originalEvent && (n = "string" === $.type(t.originalEvent.data) ? $.parseJSON(t.originalEvent.data) : t.originalEvent.data, n && (e = this.setPlayerID(n), e.length && (i = this.setVimeoAPIurl(e), n.hasOwnProperty("event") && this.handleEvent(n, e, i), n.hasOwnProperty("method") && this.handleMethod(n, e, i))))
			},
			...
			handleEvent: function (t, e, i) {
				switch (t.event.toLowerCase()) {
					case "ready":
						for (var n in $._data(e[0], "events")) n.match(/loadProgress|playProgress|play|pause|finish|seek|cuechange/) && e[0].contentWindow.postMessage(JSON.stringify({
		...
		jQuery(document).ready(function () {
			...
			if ("string" == typeof n && (o.method = n), void 0 !== typeof s && "function" != typeof s && (o.value = s), "iframe" === i.prop("tagName").toLowerCase() && o.hasOwnProperty("method"))
				if (i.data("vimeoReady")) i[0].contentWindow.postMessage(JSON.stringify(o), e.setVimeoAPIurl(i));
					...
					}), i.data("vimeoAPICall", a)
				}
			return "get" !== n.toString().substr(0, 3) && "paused" !== n.toString() || "function" != typeof s || (! function (i, n, s) {
				var o = t.setInterval(function () {
					e.catchMethods.methodreturn.length != i && (t.clearInterval(o), n(e.catchMethods.methodreturn[s]))
				}, 10)
			}(r, s, e.catchMethods.count), e.catchMethods.count++), i
	...
	function () {
		...
		var n = i.helpers = {},
			...
			x = n.calculateScaleRange = function (t, e, i, n, s) {
				...
				for (var c = Math.abs(l - h), u = k(c), p = Math.ceil(l / (1 * Math.pow(10, u))) * Math.pow(10, u), d = n ? 0 : Math.floor(h / (1 * Math.pow(10, u))) * Math.pow(10, u), v = p - d, f = Math.pow(10, u), g = Math.round(v / f);
					(g > r || r > 2 * g) && !a;)
		...
		i.instances = {}, i.Type = function (t, e, n) {
							...
							var c = [],
								...
								p = function (t) {
									...
									return n.each(this.datasets, function (t) {
										...
										s.push(t.x), o.push(t.y), c.push(n.template(this.options.multiTooltipTemplate, t)), u.push({
											fill: t._saved.fillColor || t.fillColor,
											stroke: t._saved.strokeColor || t.strokeColor
										})
									}, this), p = j(o), l = m(o), h = j(s), r = m(s), {
										x: h > this.chart.width / 2 ? h : r,
										y: (p + l) / 2
									}
								}.call(this, a);
							new i.MultiTooltip({
		...
		}), i.Element.extend = p, i.Point = i.Element.extend({
			display: !0,
			...
			initialize: function () {
				this.font = U(this.fontSize, this.fontStyle, this.fontFamily), this.titleFont = U(this.titleFontSize, this.titleFontStyle, this.titleFontFamily), this.height = this.labels.length * this.fontSize + (this.labels.length - 1) * (this.fontSize / 2) + 2 * this.yPadding + 1.5 * this.titleFontSize, this.ctx.font = this.titleFont;
			...
			buildYLabels: function () {
				this.yLabels = [];
				for (var t = C(this.stepValue), e = 0; e <= this.steps; e++) this.yLabels.push(E(this.templateString, {
			...
			calculateXLabelRotation: function () {
				...
				if (this.xScalePaddingRight = e / 2 + 3, this.xScalePaddingLeft = t / 2 > this.yLabelWidth + 10 ? t / 2 : this.yLabelWidth + 10, this.xLabelRotation = 0, this.display) {
					var s = q(this.ctx, this.font, this.xLabels),
						o, r;
					this.xLabelWidth = s;
					for (var a = Math.floor(this.calculateX(1) - this.calculateX(0)) - 6; this.xLabelWidth > a && 0 === this.xLabelRotation || this.xLabelWidth > a && this.xLabelRotation <= 90 && this.xLabelRotation > 0;) o = Math.cos(w(this.xLabelRotation)), i = o * t, n = o * e, i + this.fontSize / 2 > this.yLabelWidth + 8 && (this.xScalePaddingLeft = i + this.fontSize / 2), this.xScalePaddingRight = this.fontSize / 2, this.xLabelRotation++, this.xLabelWidth = o * s;
			...
			draw: function () {
				...
				this.display && (t.fillStyle = this.textColor, t.font = this.font, s(this.yLabels, function (s, o) {
					...
					var n = this.calculateX(i) + _(this.lineWidth),
						s = this.calculateX(i - (this.offsetGridLines ? .5 : 0)) + _(this.lineWidth),
						o = this.xLabelRotation > 0,
						r = this.showVerticalLines;
					0 !== i || r || (r = !0), r && t.beginPath(), i > 0 ? (t.lineWidth = this.gridLineWidth, t.strokeStyle = this.gridLineColor) : (t.lineWidth = this.lineWidth, t.strokeStyle = this.lineColor), r && (t.moveTo(s, this.endPoint), t.lineTo(s, this.startPoint - 3), t.stroke(), t.closePath()), t.lineWidth = this.lineWidth, t.strokeStyle = this.lineColor, t.beginPath(), t.moveTo(s, this.endPoint), t.lineTo(s, this.endPoint + 5), t.stroke(), t.closePath(), t.save(), t.translate(n, o ? this.endPoint + 12 : this.endPoint + 8), t.rotate(-1 * w(this.xLabelRotation)), t.font = this.font, t.textAlign = o ? "right" : "center", t.textBaseline = o ? "middle" : "top", t.fillText(e, 0, 0), t.restore()
				}, this))
			}
			...
			setScaleSize: function () {
				var t = j([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]),
					e, i, n, s, o = this.width,
					r, a, l = 0,
					h, c, u, p, d, v, f;
				for (this.ctx.font = U(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), i = 0; i < this.valuesCount; i++) e = this.getPointPosition(i, t), n = this.ctx.measureText(E(this.templateString, {
					value: this.labels[i]
				})).width + 5, 0 === i || i === this.valuesCount / 2 ? (s = n / 2, e.x + s > o && (o = e.x + s, r = i), e.x - s < l && (l = e.x - s, h = i)) : i < this.valuesCount / 2 ? e.x + n > o && (o = e.x + n, r = i) : i > this.valuesCount / 2 && e.x - n < l && (l = e.x - n, h = i);
				u = l, p = Math.ceil(o - this.width), a = this.getIndexAngle(r), c = this.getIndexAngle(h), d = p / Math.sin(a + Math.PI / 2), v = u / Math.sin(c + Math.PI / 2), d = y(d) ? d : 0, v = y(v) ? v : 0, this.drawingArea = t - (v + d) / 2, this.setCenterPoint(v, d)
			},
					...
					if (s(this.yLabels, function (e, i) {
						...
						for (var e = this.valuesCount - 1; e >= 0; e--) {
							...
							var o = this.labels.length,
								...
								l = a > e || e > o - a,
								h = e === a || e === o - a;
							0 === e ? t.textAlign = "center" : e === r ? t.textAlign = "center" : r > e ? t.textAlign = "left" : t.textAlign = "right", h ? t.textBaseline = "middle" : l ? t.textBaseline = "bottom" : t.textBaseline = "top", t.fillText(this.labels[e], n.x, n.y)
						}
					}
				}
			}
	...
	function () {
		...
		e.Type.extend({
			...
			getBarsAtEvent: function (t) {
				for (var e = [], n = i.getRelativePosition(t), s = function (t) {
						e.push(t.bars[o])
					}, o, r = 0; r < this.datasets.length; r++)
					for (o = 0; o < this.datasets[r].bars.length; o++)
						if (this.datasets[r].bars[o].inRange(n.x, n.y)) return i.each(this.datasets, s), e;
				return e
			},
